...
extern NSString *const kIMLEXNetworkRecorderNewTransactionNotification;
extern NSString *const kIMLEXNetworkRecorderTransactionUpdatedNotification;
extern NSString *const kIMLEXNetworkRecorderUserInfoTransactionKey;
extern NSString *const kIMLEXNetworkRecorderTransactionsClearedNotification;

@class IMLEXNetworkTransaction;

@interface IMLEXNetworkRecorder : NSObject

/// In general, it only makes sense to have one recorder for the entire application.
@property (nonatomic, readonly, class) IMLEXNetworkRecorder *defaultRecorder;
...
/// Array of IMLEXNetworkTransaction objects ordered by start time with the newest first.
