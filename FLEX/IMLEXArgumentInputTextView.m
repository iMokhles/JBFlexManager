...
#import "IMLEXColor.h"
#import "IMLEXArgumentInputTextView.h"
#import "IMLEXUtility.h"

@interface IMLEXArgumentInputTextView ()
...
@implementation IMLEXArgumentInputTextView
...
- (instancetype)initWithArgumentTypeEncoding:(const char *)typeEncoding {
    ...
    if (self) {
        ...
        self.inputTextView.backgroundColor = IMLEXColor.secondaryGroupedBackgroundColor;
        ...
        if (@available(iOS 11, *)) {
            ...
            self.inputTextView.layer.borderColor = IMLEXColor.borderColor.CGColor;
        }

        self.placeholderLabel = [UILabel new];
        self.placeholderLabel.font = self.inputTextView.font;
        self.placeholderLabel.textColor = IMLEXColor.deemphasizedTextColor;
...
- (NSUInteger)numberOfInputLines {
    switch (self.targetSize) {
        case IMLEXArgumentInputViewSizeDefault:
            return 2;
        case IMLEXArgumentInputViewSizeSmall:
            return 1;
        case IMLEXArgumentInputViewSizeLarge:
            return 8;
    }
}
