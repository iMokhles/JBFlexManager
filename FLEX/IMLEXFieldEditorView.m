...
@interface IMLEXFieldEditorView ()
...
@implementation IMLEXFieldEditorView
...
- (void)setArgumentInputViews:(NSArray<IMLEXArgumentInputView *> *)argumentInputViews {
    if (![_argumentInputViews isEqual:argumentInputViews]) {
        
        for (IMLEXArgumentInputView *inputView in _argumentInputViews) {
            [inputView removeFromSuperview];
        }
        
        _argumentInputViews = argumentInputViews;
        
        for (IMLEXArgumentInputView *newInputView in argumentInputViews) {
