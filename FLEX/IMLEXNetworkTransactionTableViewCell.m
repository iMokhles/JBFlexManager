//
//  IMLEXNetworkTransactionTableViewCell.m
//  Flipboard
//
...
NSString *const kIMLEXNetworkTransactionCellIdentifier = @"kIMLEXNetworkTransactionCellIdentifier";

@interface IMLEXNetworkTransactionTableViewCell ()
...
@implementation IMLEXNetworkTransactionTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.nameLabel.font = UIFont.IMLEX_defaultTableCellFont;
        [self.contentView addSubview:self.nameLabel];

        self.pathLabel = [UILabel new];
        self.pathLabel.font = UIFont.IMLEX_defaultTableCellFont;
...
- (void)layoutSubviews {
    ...
    self.nameLabel.textColor = (self.transaction.error || [IMLEXUtility isErrorStatusCodeFromURLResponse:self.transaction.response]) ? UIColor.redColor : IMLEXColor.primaryTextColor;
...
- (NSString *)transactionDetailsLabelText {
    ...
    if (self.transaction.transactionState == IMLEXNetworkTransactionStateFinished || self.transaction.transactionState == IMLEXNetworkTransactionStateFailed) {
        NSString *statusCodeString = [IMLEXUtility statusCodeStringFromURLResponse:self.transaction.response];
        ...
        NSString *totalDuration = [IMLEXUtility stringFromRequestDuration:self.transaction.duration];
        NSString *latency = [IMLEXUtility stringFromRequestDuration:self.transaction.latency];
        ...
        NSString *state = [IMLEXNetworkTransaction readableStringFromTransactionState:self.transaction.transactionState];
