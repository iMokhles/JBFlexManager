...
@interface IMLEXExplorerToolbarItem : UIButton
...
+ (instancetype)itemWithTitle:(NSString *)title image:(UIImage *)image sibling:(nullable IMLEXExplorerToolbarItem *)backupItem;
...
@property (nonatomic, readonly) IMLEXExplorerToolbarItem *sibling;
...
@property (nonatomic, readonly) IMLEXExplorerToolbarItem *currentItem;
