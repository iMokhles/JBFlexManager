...
@interface IMLEXManager (Extensibility)
...
/// that conflict with IMLEX, or if you like doing things the hard way ;)
...
/// @note IMLEX registers several default keyboard shortcuts. Use the '?' key to see a list of shortcuts.
