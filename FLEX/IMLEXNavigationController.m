...
@interface IMLEXNavigationController ()
...
@implementation IMLEXNavigationController
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (self.waitingToAddTab) {
        ...
        if ([self.presentingViewController isKindOfClass:[IMLEXExplorerViewController class]]) {
            // New navigation controllers always add themselves as new tabs,
            // tabs are closed by IMLEXExplorerViewController
            [IMLEXTabList.sharedList addTab:self];
