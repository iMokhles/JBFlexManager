...
#define IMLEXOSLogAvailable() (NSProcessInfo.processInfo.operatingSystemVersion.majorVersion >= 10)

/// The log controller used for iOS 10 and up.
@interface IMLEXOSLogController : NSObject <IMLEXLogController>
...
@property (nonatomic) NSMutableArray<IMLEXSystemLogMessage *> *messages;
