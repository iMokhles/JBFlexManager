...
#define IMLEXKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
// Keychain access group available at compile time
#define IMLEXKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef IMLEXKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, IMLEXKeychainQuerySynchronizationMode) {
    IMLEXKeychainQuerySynchronizationModeAny,
    IMLEXKeychainQuerySynchronizationModeNo,
    IMLEXKeychainQuerySynchronizationModeYes
};
#endif

/// Simple interface for querying or modifying keychain items.
@interface IMLEXKeychainQuery : NSObject
...
@property (nonatomic) IMLEXKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/// The #define IMLEXKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time.
