...
/// always go back and move it to \c IMLEXMethodBase if we find we need to.
@interface IMLEXMethod : IMLEXMethodBase
...
/// Constructs an \c IMLEXMethod for the given method on the given class.
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c IMLEXMethod object, or \c nil if the
...
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c IMLEXMethod object, or \c nil \e if the
...
#define IMLEXMagicNumber 0xdeadbeef
#define IMLEXArg(expr) IMLEXMagicNumber,/// @encode(__typeof__(expr)), (__typeof__(expr) []){ expr }
...
@interface IMLEXMethod (Comparison)
