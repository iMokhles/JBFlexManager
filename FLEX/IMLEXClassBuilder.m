...
@interface IMLEXClassBuilder ()
@property (nonatomic) NSString *name;
@end

@implementation IMLEXClassBuilder
...
- (NSArray *)addMethods:(NSArray *)methods {
    ...
    for (IMLEXMethodBase *m in methods) {
...
- (NSArray *)addProperties:(NSArray *)properties {
    ...
    NSMutableArray *failed = [NSMutableArray new];
    for (IMLEXProperty *p in properties) {
        unsigned int pcount;
...
- (NSArray *)addProtocols:(NSArray *)protocols {
    ...
    NSMutableArray *failed = [NSMutableArray new];
    for (IMLEXProtocol *p in protocols) {
...
- (NSArray *)addIvars:(NSArray *)ivars {
    ...
    NSMutableArray *failed = [NSMutableArray new];
    for (IMLEXIvarBuilder *ivar in ivars) {
...
@implementation IMLEXIvarBuilder
