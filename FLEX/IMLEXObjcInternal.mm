...
//////////////////////////////////////
static BOOL IMLEX_isTaggedPointer(const void *ptr)  {
...
////////////////////////////////////////////////
static BOOL IMLEX_isExtTaggedPointer(const void *ptr)  {
...
static BOOL IMLEXPointerIsReadable(const void *inPtr) {
...
BOOL IMLEXPointerIsValidObjcObject(const void *ptr) {
    ...
    if (IMLEX_isTaggedPointer(ptr) || IMLEX_isExtTaggedPointer(ptr)) {
        return YES;
    }
#endif
    ...
    if (cls && IMLEXPointerIsReadable((__bridge void *)cls)) {
        ...
        if (metaclass && IMLEXPointerIsReadable((__bridge void *)metaclass)) {
