...
@class IMLEXScopeCarousel, IMLEXWindow, IMLEXTableViewSection;

typedef CGFloat IMLEXDebounceInterval;
/// No delay, all events delivered
extern CGFloat const kIMLEXDebounceInstant;
/// Small delay which makes UI seem smoother by avoiding rapid events
extern CGFloat const kIMLEXDebounceFast;
/// Slower than Fast, faster than ExpensiveIO
extern CGFloat const kIMLEXDebounceForAsyncSearch;
/// The least frequent, at just over once per second; for I/O or other expensive operations
extern CGFloat const kIMLEXDebounceForExpensiveIO;

@protocol IMLEXSearchResultsUpdating <NSObject>
...
@interface IMLEXTableViewController : UITableViewController <
...
@property (nonatomic) IMLEXTableView *tableView;

/// If your subclass conforms to \c IMLEXSearchResultsUpdating
...
@property (nonatomic, weak) id<IMLEXSearchResultsUpdating> searchDelegate;
...
@property (nonatomic) IMLEXScopeCarousel *carousel;
...
@property (nonatomic) IMLEXDebounceInterval searchBarDebounceInterval;
...
@property (nonatomic, weak    ) id<IMLEXSearchResultsUpdating> searchResultsUpdater;
