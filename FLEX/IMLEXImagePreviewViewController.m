//
//  IMLEXImagePreviewViewController.m
//  Flipboard
//
...
@interface IMLEXImagePreviewViewController () <UIScrollViewDelegate>
...
#pragma mark -
@implementation IMLEXImagePreviewViewController

#pragma mark Initialization

+ (instancetype)previewForView:(UIView *)view {
    return [self forImage:[IMLEXUtility previewImageForView:view]];
}

+ (instancetype)previewForLayer:(CALayer *)layer {
    return [self forImage:[IMLEXUtility previewImageForLayer:layer]];
}
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithPatternImage:IMLEXResources.checkerPattern];
