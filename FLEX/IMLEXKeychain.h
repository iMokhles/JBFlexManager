...
/// Error code specific to IMLEXKeychain that can be returned in NSError objects.
/// For codes returned by the operating system, refer to SecBase.h for your
/// platform.
typedef NS_ENUM(OSStatus, IMLEXKeychainErrorCode) {
    /// Some of the arguments were invalid.
    IMLEXKeychainErrorBadArguments = -1001,
};

/// IMLEXKeychain error domain
extern NSString *const kIMLEXKeychainErrorDomain;

/// Account name.
extern NSString *const kIMLEXKeychainAccountKey;

/// Time the item was created.
///
/// The value will be a string.
extern NSString *const kIMLEXKeychainCreatedAtKey;

/// Item class.
extern NSString *const kIMLEXKeychainClassKey;

/// Item description.
extern NSString *const kIMLEXKeychainDescriptionKey;

/// Item label.
extern NSString *const kIMLEXKeychainLabelKey;

/// Time the item was last modified.
///
/// The value will be a string.
extern NSString *const kIMLEXKeychainLastModifiedKey;

/// Where the item was created.
extern NSString *const kIMLEXKeychainWhereKey;
...
@interface IMLEXKeychain : NSObject
...
///
/// @note See the `NSString` constants declared in IMLEXKeychain.h for a list of keys that
