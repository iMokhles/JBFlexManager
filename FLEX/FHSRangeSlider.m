...
//        iv.userInteractionEnabled = YES;
    ...
    _track = newSubviewImageView(IMLEXResources.rangeSliderTrack);
    _fill = newSubviewImageView(IMLEXResources.rangeSliderFill);
    _leftHandle = newSubviewImageView(IMLEXResources.rangeSliderLeftHandle);
    _rightHandle = newSubviewImageView(IMLEXResources.rangeSliderRightHandle);
}
...
- (void)layoutSubviews {
    ...
    self.leftHandle.frame = IMLEXRectMake(
    ...
    self.rightHandle.frame = IMLEXRectMake(
    ...
    self.track.frame = IMLEXRectMake(
        lhs.width / 2.f,
