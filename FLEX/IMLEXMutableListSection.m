...
@interface IMLEXMutableListSection ()
@property (nonatomic, readonly) IMLEXMutableListCellForElement configureCell;
@end

@implementation IMLEXMutableListSection
@synthesize cellRegistrationMapping = _cellRegistrationMapping;

#pragma mark - Initialization

+ (instancetype)list:(NSArray *)list
   cellConfiguration:(IMLEXMutableListCellForElement)cellConfig
...
configurationBlock:(IMLEXMutableListCellForElement)cellConfig
     filterMatcher:(BOOL(^)(NSString *, id))filterBlock {
    self = [super init];
    if (self) {
