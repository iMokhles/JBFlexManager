...
@protocol IMLEXColorComponentInputViewDelegate;

@interface IMLEXColorComponentInputView : UIView

@property (nonatomic) UISlider *slider;
@property (nonatomic) UILabel *valueLabel;

@property (nonatomic, weak) id <IMLEXColorComponentInputViewDelegate> delegate;

@end

@protocol IMLEXColorComponentInputViewDelegate <NSObject>

- (void)colorComponentInputViewValueDidChange:(IMLEXColorComponentInputView *)colorComponentInputView;

@end


@implementation IMLEXColorComponentInputView
...
- (void)layoutSubviews {
    ...
    CGFloat valueLabelOriginY = IMLEXFloor((self.slider.frame.size.height - self.valueLabel.frame.size.height) / 2.0);
...
@interface IMLEXColorPreviewBox : UIView
...
@implementation IMLEXColorPreviewBox
...
@interface IMLEXArgumentInputColorView () <IMLEXColorComponentInputViewDelegate>

@property (nonatomic) IMLEXColorPreviewBox *colorPreviewBox;
@property (nonatomic) UILabel *hexLabel;
@property (nonatomic) IMLEXColorComponentInputView *alphaInput;
@property (nonatomic) IMLEXColorComponentInputView *redInput;
@property (nonatomic) IMLEXColorComponentInputView *greenInput;
@property (nonatomic) IMLEXColorComponentInputView *blueInput;

@end

@implementation IMLEXArgumentInputColorView

- (instancetype)initWithArgumentTypeEncoding:(const char *)typeEncoding {
    self = [super initWithArgumentTypeEncoding:typeEncoding];
    if (self) {
        self.colorPreviewBox = [IMLEXColorPreviewBox new];
        ...
        self.alphaInput = [IMLEXColorComponentInputView new];
        ...
        self.blueInput = [IMLEXColorComponentInputView new];
...
- (void)layoutSubviews {
    ...
    NSArray<IMLEXColorComponentInputView *> *colorComponentInputViews = @[self.alphaInput, self.redInput, self.greenInput, self.blueInput];
    for (IMLEXColorComponentInputView *inputView in colorComponentInputViews) {
...
+ (BOOL)supportsObjCType:(const char *)type withCurrentValue:(id)value {
    ...
    return (strcmp(type, @encode(CGColorRef)) == 0) || (strcmp(type, IMLEXEncodeClass(UIColor)) == 0);
}
