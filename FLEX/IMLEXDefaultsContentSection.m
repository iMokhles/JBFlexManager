...
@interface IMLEXDefaultsContentSection ()
@property (nonatomic) NSUserDefaults *defaults;
@property (nonatomic) NSArray *keys;
@property (nonatomic, readonly) NSDictionary *whitelistedDefaults;
@end

@implementation IMLEXDefaultsContentSection
...
+ (instancetype)forDefaults:(NSUserDefaults *)userDefaults {
    IMLEXDefaultsContentSection *section = [self forReusableFuture:^id(IMLEXDefaultsContentSection *section) {
