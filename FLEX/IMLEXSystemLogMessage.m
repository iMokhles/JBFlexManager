...
@implementation IMLEXSystemLogMessage
...
+ (instancetype)logMessageFromASLMessage:(aslmsg)aslMessage {
    ...
    IMLEXSystemLogMessage *message = [[self alloc] initWithDate:date sender:sender text:text messageID:identifier];
