...
@implementation JBFlexManagerHelper

// Preferences
+ (NSString *)preferencesPath {
	return @"/User/Library/Preferences/com.imokhles.jbflexmanager.plist";
}

+ (CFStringRef)preferencesChanged {
	return (__bridge CFStringRef)@"com.imokhles.jbflexmanager.preferences-changed";
}
